...
* mozjs78: https://src.fedoraproject.org/rpms/mozjs78/pull-request/2 (已合并)
* kexec-tools: https://src.fedoraproject.org/rpms/kexec-tools/pull-request/13 (等待发行版维护者合并上游项目，之后向后移植)
